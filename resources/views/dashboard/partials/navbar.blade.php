        ...
        <div class="relative flex items-center justify-center">
            ...
            <div class="lg:mx-2">
                <div class="relative inline-block text-left">
                    <div>
                        <button type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" id="menu-button-2" aria-expanded="false" aria-haspopup="true" onclick="dropdownFunction('dropdown-menu-2')">
                            {{ auth()->user()->name }}
                    ...
                    <div class="absolute right-0 z-10 hidden w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button-2" tabindex="-1" id="dropdown-menu-2">
